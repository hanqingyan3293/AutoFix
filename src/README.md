...
| 版本 | 产物 | 运行要求 |
| --- | --- | --- |
| 标准版 | src/bin/Release/net472/Autodesk-Fix.exe | .NET Framework 4.7.2+ |
| 兼容版 | src/bin/Release/net40/Autodesk-Fix.exe | .NET Framework 4.0+（Win7 SP1 起） |
